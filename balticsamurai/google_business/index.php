...
$direct_mails = new GoogleBusiness;
...
<html lang="en">
  <head>
    ...
    <title>Google Business Leads</title>
  ...
  <body>
    ...
    <div class="container-fluid p-4">
        ...
        <div class="row">
            <div class="col-md-12">
                <h1 class="text-center">Google Business Leads</h1>
            </div>
                                ...
                                <div class="modal-dialog">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form action="reason.php" method="POST">
                                            <div class="mb-3">
                                                <input type="hidden" name="google_business_id" value="<?php echo $contact['id']; ?>">
                                                <label for="exampleInputEmail1" class="form-label">Write down the dispute reason:</label>
                                                <textarea name="reason" class="form-control" id="exampleInputEmail1" required></textarea>
                                            </div>
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
